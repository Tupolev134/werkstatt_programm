...
class InsertOrderablePartsRaw(QMainWindow):
    def __init__(self, window_manager):
        ...
        self.data_view_section_layout = QGridLayout()
        ...
        # ------------------ setup Sections ------------------
        self.import_data_view_layout()

        self.main_layout.addLayout(self.data_view_section_layout)
    ...
    def import_data_view_layout(self):
        self.data_view_section_layout.addWidget(self.last_imported_data, 0, 0)
        self.data_view_section_layout.addWidget(self.raw_data_label, 1, 0)
        self.data_view_section_layout.addWidget(self.raw_data_input, 1, 1)
        # self.raw_data_input.returnPressed.connect(self.import_data_btn.setFocus)

        self.data_view_section_layout.addWidget(self.import_data_btn)
